...
enum TokenType {
// Reserved Words:
VOID_TOKEN, MAIN_TOKEN, INT_TOKEN, COUT_TOKEN, IF_TOKEN, WHILE_TOKEN, ELSE_TOKEN, ENDL_TOKEN,
...
"VOID", "MAIN", "INT", "COUT", "IF", "WHILE", "ELSE", "ENDL",
"LESS", "LESSEQUAL", "GREATER", "GREATEREQUAL", "EQUAL", "PLUSEQUAL", "MINUSEQUAL",
"NOTEQUAL", "OR", "AND",
