...
enum CharacterType {
	LETTER_CH,DIGIT_CH,WS_CH,PLUS_CH,BAD_CH,MINUS_CH,ASTER_CH,SLASH_CH,LT_CH,GT_CH,EQ_CH,UNDER_CH,SEMI_CH,L_PAREN_CH,R_PAREN_CH,L_CURL_CH,R_CURL_CH,EXCL_CH,BAR_CH,AMP_CH,NEWLINE_CH,END_CH,LAST_CH
};
