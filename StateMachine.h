...
#include "Token.h"
enum MachineState {
	START_ST, COUT_ST, MAIN_ST, INT_ST, IF_ST, WHILE_ST,ID_ST, NUM_ST, SEMI_ST, L_PAREN_ST,R_PAREN_ST,L_CURL_ST,R_CURL_ST,NE_ST,MULT_ST,DIV_ST,SUB_ST,PL_ST,ASN_ST,NOT_ST,EQ_ST,GT_ST,GE_ST,LT_ST,LE_ST,INS_ST,CANT_MOVE_ST,L_COM_ST,B_COM_ST,B_COM_ST_2,BIT_OR_ST,BIT_AND_ST,OR_ST,AND_ST,END_ST,LAST_ST
};
enum CharacterType {
